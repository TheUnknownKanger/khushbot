...
async def startup_log_all_done():
    try:
        await bot.send_message(TELE, f"**KhushBot has been deployed.\nSend** `{CMD_HNDLR}alive` **to see if the bot is working.\n\nAdd** @{BOTNAME} **to this group and make it admin for enabling all the features of KhushBot**")
...
print("KhushBot has been deployed! ")

print("Setting up KhushBot")
...
if LOAD_MYBOT == "True":
    ...
    print("KhushBot set up completely!")

print("KhushBot set up - Level - Basic")
print("KhushBot has been fully deployed! Do Visit @deviluserbot")
