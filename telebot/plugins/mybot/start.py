    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "khushBot", url="https://github.com/TheUnknownKanger/khushbot")],
                                      [Button.inline(
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("Crashed?", "t.me/deviluserbot")]
        ])
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/TheUnknownKanger/khushbot")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTheUnknownKanger%2Fkhushbot%2F&template=https%3A%2F%2Fgithub.com%2FTheUnknownKanger%2Fkhushbot"))],
                         [Button.url("Support",
                                     url="https://t.me/deviluserbot")]
                     ])
